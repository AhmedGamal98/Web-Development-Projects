	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="tables">
					<h3 style="color:#fff;" class="title1">Participations</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>Participations Management:</h4>
						<table class="table">
							<thead>
								<tr>
									<th>National ID</th>
							...
							<tbody>
								...
								include('../connect.php');  
								$sql = $con->prepare("SELECT user.* , events.Title FROM user INNER JOIN events ON events.user_id = user.user_ID");
								$sql->execute();
								$rows = $sql->fetchAll();
