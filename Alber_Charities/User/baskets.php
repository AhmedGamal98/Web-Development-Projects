	...
	<div class="main-content">
		...
		<div class="sticky-header header-section" style="height: 80px; z-index: 9999;box-shadow: none">
			...
			<div class="header-right">
				...
				<a href="payment.php" style="margin-top:23px;margin-right:10px;background-color:#FFF; border: 1px soild #5BC0DE;color:#000" class="btn btn-info">Pay</a>
				...
				<div class="need-cases text-center">
						<div class="row">
							...
							<?php
								...
								include('../connect.php');  
								$sql = $con->prepare("SELECT * FROM  my_basket WHERE user_id=$userid");
								$sql->execute();
								$rows = $sql->fetchAll();
							   ...
							   ?>
							<div class="col-md-4">
								<div class="need" style="height: 220px;padding-top:40px">
									<p><?php echo $pat["description"]; ?></p>
									<p style="font-size:18px">Quantity: <span style="color:#FFC923"><?php echo $pat["quantity"]; ?></span></p>
									
									<p style="font-size:18px">Price: <span style="color:#FFC923"><?php echo $pat["total_price"] . " R"; ?></span></p>
									
								</div>
							</div>
							<div class="clearfix"></div>
							<a href="payment.php" style="background-color:#ffc923; border:0px;width:200px" class="btn btn-info"> Confirm</a>
							<?php } ?>
