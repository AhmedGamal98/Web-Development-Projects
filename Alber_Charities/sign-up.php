		...
		<div class="login design">
			...
			<form class="form" action="signup-conn.php" method="post">
				...
				<div class="ast">
					...
					<div class="alert alert-danger custom-alert">Password Must Be Contains At Least <strong>One Uppercase Letters.</strong></div>
					<div class="alert alert-danger lower-alert">Password Must Be Contains At Least <strong>One Lowercase Letters.</strong></div>
					<div class="alert alert-danger number-alert">Password Must Be Contains At Least <strong>One Numbers.</strong></div>
