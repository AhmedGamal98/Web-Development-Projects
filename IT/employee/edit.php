        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="col-lg-12">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                  <form action="../includes/edit_emp.php" method="POST">
                        <div class="form-group">
                            <label for="exampleInputName">User Name</label>
                            <input type="text" class="form-control" id="exampleInputName" aria-describedby="form-text"
                                      placeholder="Enter Name"  name="name" value="<?php echo $_SESSION['emp_name'];?>">
                        </div>
                        <div class="form-group">
                                <label for="exampleInputPhone">Phone Number</label>
                                <input type="number" class="form-control" id="exampleInputPhone" aria-describedby="form-text"
                                          placeholder="Enter Phonr Number" name="phone" value="0<?php echo $_SESSION['phone'];?>">
                        </div>  
                      <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password" class="form-control" name="password" id="exampleInputPassword1" placeholder="Password">
                        <small>Note: If you leave password empty it will not changed</small>
                      </div>
