      ...
      <div id="content">
        ...
        <?php }elseif($do == "add"){ ?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Trainees List</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Trainees List</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Trainees Table</h6>
                  <a href="add.php" class="btn  btn-outline-primary" ><i class="fas fa-plus"></i> Add New</a>
                </div>
                    ...
                    $rows =$sql->fetchAll($con::FETCH_ASSOC);
                      foreach ($rows as $row){
                        ...
                        echo 
                          ...
                          "<tr>
                            <td><a href='show_tr.php?tr_id=".$row['tr_id']."'>" . $row['tr_id'] . "</a></td>
                            <td>".$row['tr_name']."</td>
                            <td>".$row['tr_email']."</td>";
                            echo"
                            <td><a href='../includes/del_tr.php?id=".$row['tr_id']."' class='btn  btn-outline-danger' onclick='return confirm(\"Are you sure you want to delete this trainee?\");'><i class='fas fa-trash'></i> Delete</a></td>
