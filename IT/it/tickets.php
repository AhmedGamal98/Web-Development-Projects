                      ...
                      foreach ($rows as $row){
                        ...
                        echo 
                          ...
                          "<tr>
                            ...
                            echo"
                            <td><a href='../includes/del_tkt.php?id=".$row['tkt_id']."' class='btn  btn-outline-danger' onclick='return confirm(\"Are you sure you want to delete this ticket?\");'><i class='fas fa-trash'></i> Delete</a></td>
