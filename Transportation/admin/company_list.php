                ...
                foreach ($rows as $row){
                  ...
                  echo 
                    ...
                    "<tr>
                      ...
                      <td><a onclick='return confirm(\"Are you sure you want to delete this company?\")' href='../include/com_delete.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'> Delete </button></a></td>
