  ...
  <div class="row">
    ...
    <?php if($do == "Manage"){ ?>
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Driver List</h1>
        <a href="add_driver.php"><button type="button" style="background-color: #3a5d70 ;border:0px;" class="btn btn-primary"><i class="fas fa-plus-square"></i> Add</button></a>
      </div>
      <div class="table-responsive">
        ...
        <tbody>
        <?php
              $sql =$con->prepare("SELECT * FROM driver WHERE tc_id =?");
                ...
                foreach ($rows as $row){
                  ...
                  echo 
                    ...
                    "<tr>
                      ...
                      <td>0" . $row['phone'] . "</td>
                      <td>" . $row['adress'] . "</td>
                      <td><a onclick='return confirm(\"Are you sure you want to delete this driver?\")' href='../include/delete_driver.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'> Delete </button></a></td>
