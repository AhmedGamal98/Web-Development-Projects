    ...
    <?php if($do == "Manage"){ ?>
      ...
      <div class="table-responsive">
        ...
        <?php 
          ...
          book.package_id,book.book_flag,book.date, package.name,package.duration , student.*
        FROM
        book
        INNER JOIN
          student
          ...
          foreach ($rows as $row){
            ...
            echo 
              ...
              "<tr>
                ...
                <td>" . $date . "</td> 
                <td>" . $row['name'] . "</td>
				<td><a  href='../include/notify.php?id=".$row['id']."&date=".$date."&tc_id=".$_SESSION['id']."'><button type='button' class='btn btn-outline-success'> Send Alert  </button></a></td>
