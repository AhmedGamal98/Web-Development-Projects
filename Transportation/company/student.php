          ...
          foreach ($rows as $row){
            ...
            echo 
              ...
              "<tr>
                ...
                <td>" . $row['adress'] . "</td>   
                <td>" . $row['phone'] . "</td>   
                <td><a onclick='return confirm(\"Are you sure you want to delete this student?\")' href='../include/delete_student.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'> Delete </button></a></td>       
