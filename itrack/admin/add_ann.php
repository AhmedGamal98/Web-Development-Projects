        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <br>
                    <div class="container">
                        <form action="../include/add_ann.php" method="post">
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-form-label">Title:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="name" placeholder="Title" name="title" onkeypress="return lettersOnly(event)"
                                        required>
                                </div>
                            </div><br>
