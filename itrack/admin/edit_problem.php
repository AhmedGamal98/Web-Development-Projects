        ...
        <div class="container">
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <?php
                    $id = $_GET['id']; 
                    $sql =$con->prepare("SELECT * FROM problem_title WHERE pr_id=?");
                ...
                ?>
                    <div class="container">
                        <form action="../include/edit_pr_title.php?id=<?php echo $row['pr_id'];?>" method='post'>
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-form-label">Problem Title:</label>
                                <div class="col-sm-10">
                                    <input type="text" name="pr_title" value=<?php echo $row['pr_title']?> class="form-control" id="name" placeholder="Problem Title"
