                    ...
                    <div class="alert alert-success">
                        <svg width="30" height="30" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M39.2853 18.2363V20.0106C39.2829 24.1694 37.9363 28.2161 35.4461 31.547C32.956 34.8779 29.4559 37.3147 25.4678 38.4939C21.4796 39.673 17.2172 39.5314 13.3161 38.0902C9.41497 36.6489 6.08427 33.9852 3.82072 30.4964C1.55717 27.0075 0.482036 22.8805 0.755672 18.7307C1.02931 14.5809 2.63705 10.6307 5.33912 7.46926C8.04119 4.30784 11.6928 2.10457 15.7494 1.18804C19.8059 0.271518 24.0501 0.690841 27.8489 2.38348M39.2853 4.58207L19.9996 23.8871L14.2139 18.1014" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path>
                                ...
                                <div class="text-mass">
                                    <p>Chat has been Deleted Successfully</p>
                        </div>
                    </div> 
                <?php } ?>
                ...
                <br>
                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTableHover" style="text-transform: none;">
                            ...
                            <?php
                                ...
                                FROM student
                                INNER JOIN chat_list ON chat_list.res_id='$res_id' AND chat_list.std_id=student.std_id
                                ");
                                $sql->execute();
                                $c=0;
                                $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                    foreach ($rows as $row){
                                        ...
                                        "<tr>
                                        <td>".$c."</td>
                                        <td><a href='chat.php?std_id=".$row['std_id']."'>".$row['std_name']."</a></td>
                                        <td>
                                        
                                        <a class=' green' style='text-decoration: none;' href='chat.php?std_id=".$row['std_id']."'> <button  class='bottom green' style='background: #268540; border-radius:25px; padding: 4px 16px;border:none;color:#fff;outline-style:none;' >View </button> </a>


                                        <a class=' green' style='text-decoration: none;' onclick='return confirm(\"Are you sure you want to close this chat?\");' href='../include/close.php?std_id=".$row['std_id']."&res_id=".$res_id."&chat_id=".$row['chat_list_id']."'> <button   class='bottom green' style='background: red; border-radius:25px; padding: 4px 16px;border:none;color:#fff;outline-style:none;' >Close </button> </a>
                                        </td>
