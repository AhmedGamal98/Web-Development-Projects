                    ...
                    <div class='row'>
                        <div class="col-sm-11" id="cssmenu" style="text-transform: uppercase;">
                            <ul>
                                ...
                                <li class="dropdown"><i style="color: #2aabc0;font-size:23px;"
                            ...
                            <div class="row">
                                <div class="col-sm-12 field">
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" readonly value="<?php echo $_SESSION['res_name']?>"
                                ...
                                <div class="col-sm-12 field">
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" readonly value="<?php echo $_SESSION['email']?>"
                                ...
                                <?php
                                $sql10 =$con->prepare("SELECT unit_title
                                FROM unit
                                WHERE unit_id=?
                                ");
                                $sql10->execute([$_SESSION['department']]);
                                $row10 =$sql10->fetch();
                                ?>
                                <div class="col-sm-12 field">
                                    <div class="row">
                                        <div class="col-2">
                                            <br>
                                            <h1 style="font-size:19px;">Department:</h1>
                                        </div>
                                        <div class="col-10">
                                            <input class="form-control" type="text" readonly value="<?php echo $row10['unit_title']?>"
