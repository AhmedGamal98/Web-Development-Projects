<?php
  ...
  $std_id = $_GET['std_id'];
  $sql1 =$con->prepare("SELECT * FROM student WHERE std_id='$std_id'");
  $sql1->execute();
    ...
    <section class="track">
        <div class="container">
            ...
            <div class="text">
                    ...
                    <h3 class="name"><?php echo $row1['std_name'];?></h3>
                </div>
            </div>

            <div class="inner chatall mt-4" id="messageboard">
                <div class="chat-text">
                <?php 
                    ...
                    $sql5 = "INSERT INTO chat (message , date , student_id , receiver_id , opposer) VALUES ('$message', '$date' , '$std_id' , '$res_id' , '$std_id')"; 		
                ...
                <?php
                            ...
                            if($rows !=NULL){
                                foreach($rows as $pat){
                                if($pat['receiver_id']==$res_id && $pat['opposer']==$std_id ){
                                ...
                                }elseif($pat['student_id']==$std_id && $pat['opposer']==$res_id){
                ...
                $sql5->execute([$pat['message_id']]); 


                }

                ?>
                <form action="" class="formchat" method="post">
