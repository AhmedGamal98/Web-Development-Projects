...
$stmtt = $con->prepare("INSERT INTO  sale_returns_details(Productname  , Quantity , Sale_Return_unit_price , Total_price , SaleReturnID , ProductID

 ) VALUES(:name, :quantity, :unit,  :total , :returnid, :productid)");
...
echo '<div class="container"><div dir="rtl" class="alert alert-success">تم اضافة عملية ارجاع جديدة بنجاح
			...
			<div class="row">
				<div class="col-md-6" style="margin-top:-25px">
					 <!-- Start Finish field --> 
					   <a href="add_Return.php?do=Bill&returnid=' . $returnid . '" class="btn btn-success btn-lg add">انهاء العمليه</a>
					 <!-- End Finish field -->	
				</div>
