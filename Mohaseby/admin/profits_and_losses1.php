...
foreach($rows as $pat)
{
	...
	if(date('m' , strtotime($pat["SaleDate"])) == "01"){
		
	 	
	   $count1 = $count1 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "02"){
		
	 	
	   $count2 = $count2 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "03"){
		
	 	
	   $count3 = $count3 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "04"){
		
	 	
	   $count4 = $count4 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "05"){
		
	 	
	   $count5 = $count5 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "06"){
		
	 	
	   $count6 = $count6 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "07"){
		
	 	
	   $count7 = $count7 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "08"){
		
	 	
	   $count8 = $count8 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "09"){
		
	 	
	   $count9 = $count9 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "10"){
		
	 	
	   $count10 = $count10 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "11"){
		
	 	
	   $count11 = $count11 + 1;
	
	}
	if(date('m' , strtotime($pat["SaleDate"])) == "12"){
...
$dataPointss = array( 
	array("y" => $count1, "label" => "January" ),
	array("y" => $count2, "label" => "February" ),
	array("y" => $count3, "label" => "March" ),
	array("y" => $count4, "label" => "April" ),
	array("y" => $count5, "label" => "May" ),
	array("y" => $count6, "label" => "June" ),
	array("y" => $count7, "label" => "July" )
    );	
...
foreach($rows as $pat)
{
	...
	if(date('m' , strtotime($pat["PurchaseDate"])) == "01"){
		
	 	
	   $count13 = $count13 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "02"){
		
	 	
	   $count14 = $count14 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "03"){
		
	 	
	   $count15 = $count15 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "04"){
		
	 	
	   $count16 = $count16 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "05"){
		
	 	
	   $count17 = $count17 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "06"){
		
	 	
	   $count18 = $count18 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "07"){
		
	 	
	   $count19 = $count19 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "08"){
		
	 	
	   $count20 = $count20 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "09"){
		
	 	
	   $count21 = $count21 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "10"){
		
	 	
	   $count22 = $count22 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "11"){
		
	 	
	   $count23 = $count23 + 1;
	
	}
	if(date('m' , strtotime($pat["PurchaseDate"])) == "12"){
...
$dataPoint = array(
	array("y" => $count13, "label" => "January" ),
	array("y" => $count14, "label" => "February" ),
	array("y" => $count15, "label" => "March" ),
	array("y" => $count16, "label" => "April" ),
	array("y" => $count17, "label" => "May" ),
	array("y" => $count18, "label" => "June" ),
	array("y" => $count19, "label" => "July" )
					 ...
					 <div class="col-md-4">
						 <div class="year">
							 <ul class="list-unstyled">
								 ...
								 <a href="profits_and_losses1.php"><li class="ye">الشهر</li></a>
