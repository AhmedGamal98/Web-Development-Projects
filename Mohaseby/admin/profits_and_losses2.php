...
foreach($rows as $pat)
{
	...
	if(date('d' , strtotime($pat["SaleDate"])) == "01"){
		
	 	
	   $count1 = $count1 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "02"){
		
	 	
	   $count2 = $count2 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "03"){
		
	 	
	   $count3 = $count3 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "04"){
		
	 	
	   $count4 = $count4 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "05"){
		
	 	
	   $count5 = $count5 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "06"){
		
	 	
	   $count6 = $count6 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "07"){
		
	 	
	   $count7 = $count7 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "08"){
		
	 	
	   $count8 = $count8 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "09"){
		
	 	
	   $count9 = $count9 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "10"){
		
	 	
	   $count10 = $count10 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "11"){
		
	 	
	   $count11 = $count11 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "12"){
		
	 	
	   $count12 = $count12 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "13"){
		
	 	
	   $count13 = $count13 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "14"){
		
	 	
	   $count14 = $count14 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "15"){
		
	 	
	   $count15 = $count15 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "16"){
		
	 	
	   $count16 = $count16 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "17"){
		
	 	
	   $count17 = $count17 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "18"){
		
	 	
	   $count18 = $count18 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "19"){
		
	 	
	   $count19 = $count19 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "20"){
		
	 	
	   $count20 = $count20 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "21"){
		
	 	
	   $count21 = $count21 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "22"){
		
	 	
	   $count22 = $count22 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "23"){
		
	 	
	   $count23 = $count23 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "24"){
		
	 	
	   $count24 = $count24 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "25"){
		
	 	
	   $count25 = $count25 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "26"){
		
	 	
	   $count26 = $count26 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "27"){
		
	 	
	   $count27 = $count27 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "28"){
		
	 	
	   $count28 = $count28 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "29"){
		
	 	
	   $count29 = $count29 + 1;
	
	}
	if(date('d' , strtotime($pat["SaleDate"])) == "30"){
...
$dataPointss = array( 
	array("y" => $count1, "label" => "Day 1" ),
	array("y" => $count2, "label" => "Day 2" ),
	array("y" => $count3, "label" => "Day 3" ),
	array("y" => $count4, "label" => "Day 4" ),
	array("y" => $count5, "label" => "Day 5" ),
	array("y" => $count6, "label" => "Day 6" ),
	array("y" => $count7, "label" => "Day 7" )
    );	
...
foreach($rows as $pat)
{
	...
	if(date('d' , strtotime($pat["PurchaseDate"])) == "01"){
		
	 	
	   $count13 = $count13 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "02"){
		
	 	
	   $count14 = $count14 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "03"){
		
	 	
	   $count15 = $count15 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "04"){
		
	 	
	   $count16 = $count16 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "05"){
		
	 	
	   $count17 = $count17 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "06"){
		
	 	
	   $count18 = $count18 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "07"){
		
	 	
	   $count19 = $count19 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "08"){
		
	 	
	   $count20 = $count20 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "09"){
		
	 	
	   $count21 = $count21 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "10"){
		
	 	
	   $count22 = $count22 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "11"){
		
	 	
	   $count23 = $count23 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "12"){
		
	 	
	   $count24 = $count24 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "13"){
		
	 	
	   $count25 = $count25 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "14"){
		
	 	
	   $count26 = $count26 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "15"){
		
	 	
	   $count27 = $count27 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "16"){
		
	 	
	   $count28 = $count28 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "17"){
		
	 	
	   $count29 = $count29 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "18"){
		
	 	
	   $count30 = $count30 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "19"){
		
	 	
	   $count31 = $count31 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "20"){
		
	 	
	   $count32 = $count32 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "21"){
		
	 	
	   $count33 = $count33 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "22"){
		
	 	
	   $count34 = $count34 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "23"){
		
	 	
	   $count35 = $count35 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "24"){
		
	 	
	   $count36 = $count36 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "25"){
		
	 	
	   $count37 = $count37 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "26"){
		
	 	
	   $count38 = $count38 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "27"){
		
	 	
	   $count39 = $count39 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "28"){
		
	 	
	   $count40 = $count40 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "29"){
		
	 	
	   $count41 = $count41 + 1;
	
	}
	if(date('d' , strtotime($pat["PurchaseDate"])) == "30"){
...
$dataPoint = array(
	array("y" => $count13, "label" => "Day 1" ),
	array("y" => $count14, "label" => "Day 2" ),
	array("y" => $count15, "label" => "Day 3" ),
	array("y" => $count16, "label" => "Day 4" ),
	array("y" => $count17, "label" => "Day 5" ),
	array("y" => $count18, "label" => "Day 6" ),
	array("y" => $count19, "label" => "Day 7" )
					 ...
					 <div class="col-md-4">
						 <div class="year">
							 <ul class="list-unstyled">
								 ...
								 <a href="profits_and_losses.php"><li>السنه</li></a>
								 <a href="profits_and_losses1.php"><li>الشهر</li></a>
								 <a href="profits_and_losses2.php"><li class="ye">الأسبوع</li></a>
							 </ul>
						 </div>
					 </div>
					 <!-- Start Stats -->
