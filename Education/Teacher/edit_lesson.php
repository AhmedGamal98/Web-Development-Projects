        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="main-title">تعديل درس لمادة : <?php echo $sub_name;?></h3><br>
                        </div>
                        <!-- /.col -->
                    </div>
                    <form class="add_sub" method="post" enctype='multipart/form-data' action="../include/edit_lesson.php?sub_id=<?php echo $sub_id ?>&&les_id=<?php echo $less_id?>">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-2 col-form-label">اسم الدرس</label>
                          <div class="col-sm-10">
                          <?php
                                $sql =$con->prepare("SELECT name FROM lesson WHERE id=?");
                                $sql->execute([$less_id]);
                                
                                $row =$sql->fetch();
                                
                        ?>
                            <input type="text" name="name" class="form-control" value="<?php echo $row['name'];?>" id="name_subject" required>
                          </div>
                        </div>
                        <div class="row mb-3">
