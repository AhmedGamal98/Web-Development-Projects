        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    ...
                    <form class="add_sub" method="post" action="../include/add_result.php?id=<?php echo $sub_id;?>">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-4 col-form-label">كود الطالب</label>
                          <div class="col-sm-8">
                            <input type="number" class="form-control" name="std_id" id="name_subject" required>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control amount" name="d_1" id="amount"  onblur="findTotal()"required>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="result" class="col-sm-4 col-form-label">درجة الاختبار الثاني</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control amount" name="d_2" id="amount" onblur="findTotal()" required>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="result" class="col-sm-4 col-form-label">درجة الاختبار الثالث</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control amount" name="d_3" id="amount" onblur="findTotal()" required>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="result" class="col-sm-4 col-form-label">درجة اختبار منتصف السنة الاول</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control amount" name="d_4" id="amount" onblur="findTotal()" required>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="result" class="col-sm-4 col-form-label">درجة اختبار منتصف السنة الثاني</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control amount" name="d_5" id="amount" onblur="findTotal()" required>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <label for="result" class="col-sm-4 col-form-label">درجة اختبار نهاية السنة</label>
                            <div class="col-sm-8">
                              <input type="text" class="form-control amount" name="d_6" id="amount" onblur="findTotal()" required>
                            </div>
                          </div>
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                              <input type="number" class="form-control" name="total" id="result" required readonly>
                            </div>
                          </div>
