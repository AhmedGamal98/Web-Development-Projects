        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="main-title">قائمة اختبارات مادة : <?php echo $sub_name?></h3><br>
                        </div>
                        <div class="col-sm-6">
                            <a href="add_test.php" style="float: left;"><button type="button" class="btn btn-outline-primary">إضافة اختبار  جديدة</button></a>
                        </div>
                        <!-- /.col -->
                    </div>
                    <table class="table">
                        ...
                        <?php
                                ...
                                exam.exam_name , exam.class_id , exam.id , subject.subject_name ,class.name
                                FROM
                                exam 
                                INNER JOIN
                                subject
                                ...
                                foreach ($rows as $row){
                                    ...
                                    <td><a onclick='return confirm(\"هل أنت متأكد من حذف هذا الاختبار\")' href='../include/delete_exam.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'>حذف</button></a></td>   
