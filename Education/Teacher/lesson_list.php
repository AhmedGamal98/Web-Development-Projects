        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="main-title">قائمة دروس مادة : <?php echo $sub_name;?></h3><br>
                        </div>
                        <div class="col-sm-6">
                            <a href="add_lesson.php" style="float: left;"><button type="button" class="btn btn-outline-primary">إضافة درس  جديدة</button></a>
                        </div>
                        <!-- /.col -->
                    </div>
                    <table class="table">
                        ...
                        <tbody>
                        <?php
                                $sql =$con->prepare("SELECT id,name FROM lesson WHERE subject_id=?");
                                $sql->execute([$sub_id]);
                                ...
                                $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                    ...
                                    <td>" . $row['name'] . "</td>
                                    <td><a href='edit_lesson.php?id=".$row['id']."''><button type='button' class='btn btn-outline-primary'>تعديل</button></a></td>
                                    <td><a onclick='return confirm(\"هل أنت متأكد من حذف هذا الدرس\")' href='../include/delete_lesson.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'>حذف</button></a></td>   
