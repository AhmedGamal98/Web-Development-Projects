        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="main-title">جدول أوقات المعلم</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
                          ...
                          <tr>
                            ...
                            <?php
                                ...
                                $id = $_SESSION['id'];
                                    ...
                                    schedule.subject_id,schedule.class_id , subject.subject_name ,class.name
                                    FROM
                                    schedule 
                                    INNER JOIN
                                    subject
                                    ...
                                    WHERE  schedule.session_day=? AND schedule.session_name=? AND schedule.subject_id=?");

                                    $sql->execute([$day,$num,$t_id]);
