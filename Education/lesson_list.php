                    ...
                    <table class="table">
                        ...
                        <?php
                                ...
                                $class_id = $_SESSION['class_id'];
                                    ...
                                    schedule.subject_id  , subject.subject_name  
                                    FROM
                                    schedule 
                                    INNER JOIN
                                    subject
                                    ...
                                    if($row != False){
                                       ...
                                       echo' <th scope="row">'.$row['subject_id'].'</th>';
                                        ...
                                        echo'<td><a href="view_lesson_list.php?id='.$row['subject_id'].'"><button style="width:200px" type="button" class="btn btn-outline-primary">عرض قائمة الدروس</button></a></td>';
                                        echo"</tr>";
                                    }
                                    else{
                                        echo "<td></td>";
