        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center" dir="rtl">
            ...
            <li class="nav-item active" styel="margin: 0 45px;">
              <a class="nav-link" href="teacher.php">المدرسيين</a>
            </li>
            <?php if(isset($_SESSION['password']) && isset($_SESSION['class_id'])){
              echo'
    ...
    <div class="row">
      <div class="col-md-11">
        <ul style="float:right;" class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a style="color: #fff;" class="h2 text-primary font-secondary" href="teacher.php">المدرسين</a></li>
          <li style="color: #fff;" class="list-inline-item text-white h3 font-secondary @@nasted"></li>
        </ul><br><br><br>
...
<section class="section" dir="rtl">
  <div class="container">
    ...
    <div class="row">
    <?php
      $sql =$con->prepare("SELECT * FROM teacher WHERE teacher_id=?");
      ...
      $row =$sql->fetch();
        ...
        <img class="img-fluid w-100" src="assest/images/teachers/avatar.jpeg" alt="teacher">
        </div>
        <div class="col-md-6 mb-5">
          <h3 style="float: right;">'.$row['name'].'</h3><br><br><br><br>
            <h4 style="float: right;" class="mb-4">جهات الاتصال:</h4><br><br><br><br>
            <ul style="float: right;" class="list-unstyled">
              <li class="mb-3"><a class="text-color" href="mailto:'.$row['email'].'">'.$row['email'].' <i class="ti-email mr-2"></i></a></li>
              <li class="mb-3"><a class="text-color" href="callto:0'.$row['phone'].'">0'.$row['phone'].' <i style="float: right;" class="ti-mobile mr-2"></i></a></li>
            </ul>
