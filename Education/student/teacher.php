    ...
    <div class="row">
      <div class="col-12">
        ...
        <ul class="list-inline text-center filter-controls mb-5" style='color:black;'>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".arts">الاحياء</li>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".bio-science">التاريخ</li>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".business-study">الجغرافيا</li>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".law">اللغة الإنجليزية</li>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".pharmacy">الكيمياء</li>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".science">الفيزياء</li>
          <li class="list-inline-item m-3 text-uppercase" data-filter=".social-science">الفلسفة</li>
        </ul>
      </div>
    </div>
    <!-- teacher list -->
