  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 mb-5">
        <h3 style="float: right;">اسم المعلم</h3><br><br><br><br>
          <h4 style="float: right;" class="mb-4">جهات الاتصال:</h4><br><br><br><br>
          <ul style="float: right;" class="list-unstyled">
            <li class="mb-3"><a class="text-color" href="mailto:johndoe@email.com">johndoe@email.com <i class="ti-email mr-2"></i></a></li>
            <li class="mb-3"><a class="text-color" href="callto:+120345876">96000000000000+ <i style="float: right;" class="ti-mobile mr-2"></i></a></li>
          </ul>
