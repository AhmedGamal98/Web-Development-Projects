    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <form class="add_sub" action="profile.php">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-2 col-form-label">اسم الطالب</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="name_subject"  value="طالب" required>
                          </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">رقم الهاتف</label>
                            <div class="col-sm-10">
                              <input type="number" class="form-control" id="name_subject"  value="9600000" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">البريد الاإلكتروني</label>
                            <div class="col-sm-10">
                              <input type="email" class="form-control" id="name_subject"  value="Ex@ex.com" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">الرقم السري</label>
                            <div class="col-sm-10">
                              <input type="password" class="form-control" id="name_subject" value="************" required>
                            </div>
                        </div>
                                                
                        <button type="submit" class="btn btn-primary">نعديل</button>
                      </form>
