    ...
    <div class="wrapper">
            ...
            <div class="sidebar">
                <div>
                 ...
                 with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                <a href="lesson_list.php" class="nav-link active">
        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <h1 class="main-title">اسم الدرس</h1><br>
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/j06DuMrn9n0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                      </div><br><br>
