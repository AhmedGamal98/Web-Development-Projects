        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="main-title"> اختبار شهر</h3><br>
                        </div>
                        <div class="col-sm-6">
                            <div style="color:#5c5c77;font-size:25px;float:left;margin-left:50px;"> <span id="time">05:00</span> </div>
                        </div>
                        <!-- /.col -->
                    </div>
                    <form class="add_sub" action="test_list.php">
                        <div class="row mb-3">
                          <label for="frist" class="col-sm-2 col-form-label">السؤال الاول</label>
                          
                          <div class="col-sm-9">
                            <label for="frist" class="col-sm-2 col-form-label">ما هي مكونات؟</label><br><br>
