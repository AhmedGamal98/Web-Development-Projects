                ...
                <div class="container">
                    <table class="table">
                        ...
                        <?php
                                    ...
                                    $sql =$con->prepare("SELECT * FROM lesson WHERE subject_id=?");
                                    ...
                                    if($row != False){
                                       ...
                                       echo' <th scope="row">'.$row['id'].'</th>';
                                        ...
                                        echo'<td><a href="view_lesson.php?id='.$row['id'].'"><button style="width:200px" type="button" class="btn btn-outline-primary">ابدأ الدرس</button></a></td>';
                                        echo"</tr>";
                                    }
                                    else{
                                        echo "<td></td>";
