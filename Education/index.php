  ...
  <div class="top-header py-2 bg-white">
    <div class="container">
      ...
      <?php }elseif($do == "success"){ ?>
          <div class="col-lg-4 text-center text-lg-left">
          <div style="width:550px;color:#2F4F37;background-color:#C5E7CD;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
               تمت عملية تسجيل حساب بنجاح يمكنك الان تسجيل الدخول
            </div>
        </div>
      <?php }elseif($do == "error"){ ?>  
        <div class="col-lg-4 text-center text-lg-left">
        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
               البريد الإلكتروني او اسم المستخدم متسخدمين بالفعل من قبل مستخدم آخر
            </div>
        </div>
        <?php }elseif($do == "error2"){ ?>  
        <div class="col-lg-4 text-center text-lg-left">
        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
               البريد الإلكتروني او كلمة السر خطأ. نرجو ادخال بيانات صحيحة
            </div>
        </div>
        <?php }elseif($do == "error3"){ ?>  
        <div class="col-lg-4 text-center text-lg-left">
        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
               هذا المعلم موجود في قائمة الانتظار حاليا. لا يمكنك تسجيل الدخول
            </div>
        </div>
        <?php }elseif($do == "error4"){ ?>  
        <div class="col-lg-4 text-center text-lg-left">
        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
               هذا المعلم تم رفضه من قبل الأدمن. لا يمكنك تسجيل الدخول
            </div>
        </div>
        <?php }elseif($do == "should"){ ?>  
        <div class="col-lg-4 text-center text-lg-left">
        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
               لا يمكنك الذهاب الي هذه الصفحة يجب عليك تسجيل الدخول اولا
            </div>
        </div>
      <?php } ?>
  ...
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content rounded-0 border-0 p-4">
          ...
          <div class="modal-body">
              <div class="login">
                  <form action="include/sign_up_teacher.php" method='post' class="row">
                      <div class="col-12">
                          <input type="text" class="form-control mb-3 " id="signupName" name="name" placeholder="الاسم" required>
            ...
            <input type="number" class="form-control mb-3 code" id="signupPhone" name="phone" placeholder="رقم الهاتف">
            <i class="glyphicon glyphicon-ok check"></i>
            <i class="glyphicon glyphicon-remove close"></i>
            ...
            <div class="alert alert-danger number-alert">كلمة المرور يجب أن تحتوي علي <strong>5 أرقام.</strong></div>
                      ...
                      <div class="col-12 ast">
                      <div style="width:550px;color:#00779C;background-color:#C0F0FF;text-align: center;padding:12px;border-radius:8px;font-size:15px;" >
...
<div class="modal fade login" dir="rtl" id="signupModal2" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content rounded-0 border-0 p-4">
          ...
          <div class="modal-body">
              <div class="login">
                  <form action="include/sign_up_student.php" method="post" class="row">
                      <div class="col-12">
                          <input type="text" class="form-control mb-3 " id="signupName" name="name" placeholder="الاسم" required>
            <i class="glyphicon glyphicon-ok check"></i>
            <i class="glyphicon glyphicon-remove close"></i>
            ...
            <div class="alert alert-danger custom-alert">الاسم يجب أن يحتوي علي <strong>حروف فقط.</strong></div>
                      ...
                      <div class="col-12 ast">
            <input type="number" class="form-control mb-3 code" id="signupPhone" name="phone" placeholder="رقم الهاتف" required>
            <i class="glyphicon glyphicon-ok check"></i>
            <i class="glyphicon glyphicon-remove close"></i>
            <div class="alert alert-danger empty-alert">رقم الهاتف لا يمكن أن يترك <strong>فارغ</strong></div>
            <div class="alert alert-danger long-alert"> رقم الهاتف يجب أن لا يقل عن <strong>11 أرقام</strong></div>
           ...
           <div class="col-12 ast">
            <select class="form-control  mb-3 " id="signupGemder" name="gender" aria-label="" style="height:58px;" required> 
...
<div class="modal fade login" dir="rtl" id="loginModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content rounded-0 border-0 p-4">
          ...
          <div class="modal-body">
              <form action="include/sign_in.php" method="post" class="row">
                  <div class="col-12 ast">
                          <input type="email" class="form-control mb-3 email" id="signupEmail" name="email" placeholder="البريد الالكتروني" required>
            <i class="glyphicon glyphicon-ok check"></i>
            <i class="glyphicon glyphicon-remove close"></i>
      ...
      <div class="modal-content rounded-0 border-0 p-4">
          ...
          <div class="modal-body">
              <form action="#" class="row">
                  <div class="col-12 ast">
                          <input type="email" class="form-control mb-3 email" id="signupEmail" name="signupEmail" placeholder="البريد الالكتروني" required>
            <i class="glyphicon glyphicon-ok check"></i>
            <i class="glyphicon glyphicon-remove close"></i>
            <div class="alert alert-danger empty-alert">البريد الالكتروني لا يمكن أن يترك <strong>فارغ</strong></div>
            <div class="alert alert-danger long-alert">البريد الالكتروني يجب أن يحتوي علي <strong>@</strong></div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        ...
        <h2 class="section-title text-white">انقر للانضمام إلي منصة دروسي التعليمية</h2>
        <a href="#" class="btn btn-secondary" data-toggle="modal" data-target="#signupModal2">انضم الآن</a>
      </div>
    </div>
  </div>
</section>
...
<section class="section" id="teacher">
  <div class="container">
    ...
    <div class="row justify-content-center">
    <?php
      $sql =$con->prepare("SELECT * FROM teacher LIMIT 3");
