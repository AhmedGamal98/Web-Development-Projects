    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <form class="add_sub" method="post" action="include/edit_student_profile.php">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-2 col-form-label">اسم الطالب</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name_subject"  value="<?php echo $_SESSION['name'];  ?>" required>
                          </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">رقم الهاتف</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="phone" id="name_subject"  value="0<?php echo $_SESSION['phone'];  ?>"  onkeypress="return /[0-9]/i.test(event.key)"  required minlength= "10">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">البريد الاإلكتروني</label>
                            <div class="col-sm-10">
                              <input type="email" class="form-control" name="email" id="name_subject"  value="<?php echo $_SESSION['email'];  ?>" required >
                            </div>
                        </div>
                        <div class="row mb-3">
