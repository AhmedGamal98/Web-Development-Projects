    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: #fff;">
                ...
                <div class="container-fluid">
                    ...
                    <?php }elseif($do == "error"){ ?>
                        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:16px;margin-right:200px; margin-bottom:40px;" >
                         هذا المعلم لا يمكنه تدريس مادة اخرى
                         </div>
                         <div class="col-sm-10">
                            <h1 class="main-title">إضافة مادة جديدة</h1>
                        </div>
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <form class="add_sub" method="post" action="../include/add_subject.php">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-2 col-form-label">اسم المادة</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="sub_name" id="name_subject" required>
                          </div>
                        </div>
                        <div class="row mb-3">
