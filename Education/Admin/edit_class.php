    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                <?php
                                $sql =$con->prepare("SELECT name FROM class WHERE id=?");
                                $sql->execute([$id]);
                    ...
                    ?>
                    <form class="add_sub" method="post" action="../include/edit_class.php?id=<?php echo $id ?>">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-2 col-form-label">اسم الفصل</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $row['name'];?>" name="class_name" id="name_subject" required>
                          </div>
                        </div>
