                    ...
                    <table class="table">
                        ...
                        <?php
                                $sql = $con->prepare("SELECT DISTINCT 
                                        schedule.class_id, class.id , class.name 
                                    FROM
                                    schedule
                                    INNER JOIN
                                        class
                                ...
                                $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                    ...
                                    <td>" . $row['name'] . "</td>
                                    <td><a  href='schedule.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'> الجدول الدراسي</button></a></td> 
                                    <td><a onclick='return confirm(\"هل أنت متأكد من حذف هذا الجدول\")'  href='../include/delete_schedule.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'> حذف</button></a></td>  
