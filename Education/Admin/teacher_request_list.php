        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    ...
                    <?php if($do == "Manage"){ ?>
                        <div class="col-sm-6">
                            <h1 class="main-title">قائمة  طلبات انضمام المعلمين</h1>
                        </div>
                        <!-- /.col -->
                    <?php }elseif($do == "accept"){ ?>
                        <div style="width:550px;color:#2F4F37;background-color:#C5E7CD;text-align: center;padding:12px;border-radius:8px;font-size:16px;margin-right:200px; margin-bottom:40px;" >
                         تم قبول المعلم بنجاح يمكنك رؤية بياناته في قائمة المعلمين
                         </div>
                         <div class="col-sm-6">
                            <h1 class="main-title">قائمة  طلبات انضمام المعلمين</h1>
                        </div>
                        ...
                        <thead>
                          ...
                          <?php
                                ...
                                $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                    ...
                                    <td>" . $row['email'] . "</td>
                                    <td>" . $row['phone'] . "</td>
                                    <td><a onclick='return confirm(\"هل انت متأكد من قبول هذا المعلم؟\")' href='../include/accept_teacher.php?id=".$row['teacher_id']."'><button type='button' class='btn btn-outline-success'>قبول</button></a></td>
                                    <td><a onclick='return confirm(\"هل أنت متأكد من رفض هذا المعلم\")' href='../include/reject_teacher.php?id=".$row['teacher_id']."'><button type='button' class='btn btn-outline-danger'>رفض</button></a></td>   
