            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    ...
                    <?php if($do == "Manage"){ ?>
                        ...
                        <!-- /.col -->
                        <div class="col-sm-2">
                            <a href="add_student.php"><button type="button" style="margin-right:310px;" class="btn btn-outline-primary">إضافة طالب إلي فصل</button></a>
                        </div>
                        <!-- /.col -->
                    <?php }elseif($do == "edit"){ ?>
                        ...
                        <thead>
                          ...
                          <?php
                                ...
                                foreach ($rows as $row){
                                    ...
                                    <td>" . $row['email'] . "</td>
                                    <td>" . $row['phone'] . "</td>
                                    <td><a onclick='return confirm(\"هل أنت متأكد من حذف هذا الطالب\")' href='../include/delete_student.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'>حذف</button></a></td>   
