        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    ...
                    <?php if($do == "Manage"){ ?>
                        <div class="col-sm-6">
                            <h1 class="main-title">قائمة المعلمين</h1>
                        </div>
                        <!-- /.col -->
                    ...
                    <table class="table table-striped">
                        ...
                        <?php
                                ...
                                $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                    ...
                                    <td>" . $row['email'] . "</td>
                                    <td>" . $row['phone'] . "</td>
                                    <td><a onclick='return confirm(\"هل أنت متأكد من حذف هذا المعلم\")' href='../include/delete_teacher.php?id=".$row['teacher_id']."'><button type='button' class='btn btn-outline-danger'>حذف</button></a></td>   
