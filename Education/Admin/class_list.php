        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    ...
                    <?php if($do == "Manage"){ ?>
                        <div class="col-sm-10">
                            <h1 class="main-title">قائمة الفصول</h1>
                        </div>
                        <div class="col-sm-2">
                            <a href="add_class.php"><button type="button" class="btn btn-outline-primary">إضافة فصل  جديدة</button></a>
                        </div>
                        <!-- /.col -->
                    ...
                    <table class="table table-striped">
                        ...
                        <?php
                                ...
                                $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                    ...
                                    <td>" . $row['name'] . "</td>
                                    <td><a  href='edit_class.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'>تعديل</button></a></td>   
                                    <td><a onclick='return confirm(\"هل أنت متأكد من حذف هذا الفصل\")' href='../include/delete_class.php?id=".$row['id']."'><button type='button' class='btn btn-outline-danger'>حذف</button></a></td>   
