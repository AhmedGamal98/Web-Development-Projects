        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    ...
                    <?php if($do == "Manage"){ ?>
                        <div class="col-sm-6">
                            <h1 class="main-title">قائمة الطلاب</h1>
                        </div>
                        <!-- /.col -->
                    <?php }elseif($do == "error"){ ?>
                    ...
                    <?php }elseif($do == "error2"){ ?>
                        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:16px;margin-right:200px; margin-bottom:40px;" >
                         هذا الطالب مسجل بهذا الفصل بالفعل
                         </div>
                         <div class="col-sm-6">
                            <h1 class="main-title">قائمة الطلاب</h1>
                        </div>
                    ...
                    <?php }elseif($do == "error3"){ ?>
                        <div style="width:550px;color:#2B060A;background-color:#F2A3AA;text-align: center;padding:12px;border-radius:8px;font-size:16px;margin-right:200px; margin-bottom:40px;" >
                         هذا الطالب مسجل بفصل من قبل لا يمكن اضافته لفصل اخر
                         </div>
                         <div class="col-sm-6">
                            <h1 class="main-title">قائمة الطلاب</h1>
                        </div>
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <form class="add_sub" method="post" action="../include/add_student.php">
                        <div class="row mb-3">
                          <label for="student_code" class="col-sm-2 col-form-label">كود الطالب</label>
                          <div class="col-sm-10">
                            <input type="number" name="st_id" class="form-control" id="student_code"  required>
                          </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">اخترالفصل</label>
                            <div class="col-sm-10">
