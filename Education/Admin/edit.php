...
<head>
    ...
    $("form[name='edit']").validate({
        ...
        messages: {
        password: {
            minlength: "كلمة المرور يجب الا تقل عن 10",
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content" style="margin-left:20px; margin-right:30px;">
                <div class="container">
                    <form class="add_sub" method="post" name="edit" action="../include/edit_admin_profile.php">
                        <div class="row mb-3">
                          <label for="name_subject" class="col-sm-2 col-form-label">اسم الادمن</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name"  value="<?php echo $_SESSION['name']; ?>" required><br>
                          </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">البريد الاإلكتروني</label>
                            <div class="col-sm-10">
                              <input type="email" class="form-control" name="email" id="email"  value="<?php echo $_SESSION['email']; ?>" required><br>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="name_subject" class="col-sm-2 col-form-label">الرقم السري</label>
                            <div class="col-sm-10">
                              <input type="password" class="form-control" name="password" id="password" value="" minlength= "10"><br>
