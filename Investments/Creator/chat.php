                              ...
                              <tbody>
								  <?php
									...
									$sql = $con->prepare("SELECT DISTINCT
										   messages.opposer , investor.Fname
									   FROM
										  messages
									   INNER JOIN
										  investor
									   ...
									   ON
										  messages.opposer = investor.nationalid
										  

									   WHERE messages.creator_ID=$id");
									$sql->execute();
									$rows = $sql->fetchAll();
								  ...
								  ?>
									<tr>
									  ...
									  <td><a title="Chat" href="chat.php?do=Chat&investorid=<?php echo $pat["opposer"]; ?>" style="text-decoration:none;color:#515A5A"><?php echo $pat["Fname"]; ?></a>
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="requisition.php"><i class="fa fa-envelope-o"></i><span>My Requisition Lists</span></a></li>
				  ...
				  <li><a href="../home_page.php"><i class="fa fa-home"></i><span>My Home Page</span></a></li>
				  <li class="activ"><a href="chat.php"><i class="fa fa-comments"></i><span>Chat</span></a></li>
				  <li><a href="../homepage.php"><i class="fa fa-sign-out"></i><span>Logout</span></a></li>
		      </ul>
		    </div>
	 </div>	
	<div class="clearfix"> </div>
