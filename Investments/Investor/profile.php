...
<div class="inner-block" style="margin-left:50px">
   <div class="boost-icons">
	 ...
	 include('../connect.php');  						  
	 $stmt = $con->prepare("SELECT * FROM investor WHERE nationalid= ? LIMIT 1");
...
<div class="inner-block" style="margin-top:0;padding-top:30px">
    <div class="inbox">
    	  ...
    	  <div class="info" style="display:inline">
			  ...
			  <span style="display:block;margin-left:70px">Investor</span>
		  </div>
		  <div class="information" style="margin-top:30px">
			  <div class="row">
				  <form class="form" action="?do=Update" method="post">
					  <input class="form-control" type="hidden" name="investorid" autocomplete="off" value="<?php echo $id; ?>"/>
					  <div class="details">
						  <div class="col-md-7">
							  <div class="in">
								  <label>First Name</label>
								  <input class="form-control" type="text" name="first" autocomplete="off" value="<?php echo $row["Fname"]; ?>"/>
							  </div>
							  <div class="in">
								  <label>Last Name</label>
								  <input class="form-control" type="text" name="last" autocomplete="off" value="<?php echo $row["Lname"]; ?>"/>
							  </div>
							  <div class="in">
								  <label>ID</label>
								  <!-- Switch -->
								 ...
								 ?>
								  ...
								  <input class="form-control" type="text" name="id" autocomplete="off" value="<?php echo $row["nationalid"]; ?>"/>
							  </div>
							  <div class="in">
								  <label>Age</label>
							  ...
							  <div class="in">
								  <label>Email</label>
								  <input class="form-control" type="email" name="email" autocomplete="off" value="<?php echo $row["Email"]; ?>"/>
							  </div>
							  <div class="in">
								  <label>Gender</label>
							  ...
							  <div class="in">
								  <label>City</label>
								  <input class="form-control" type="text" name="city" autocomplete="off" value="<?php echo $row["City"]; ?>"/>
							  ...
							  <div class="in">
								  ...
								  <input class="form-control" type="tel" name="phone" autocomplete="off" value="<?php echo "0" . $row["PhoneNum"]; ?>"/>
							  </div>
							  <div class="in">
							  ...
							  <div class="in">
								  ...
								  <div class="custom-control custom-switch">
								  <?php
									if($row['budget_check'] == 0){
										echo'<input type="checkbox" class="custom-control-input" name="bud_c" value="1" id="custom-switch-2" >';	
									}else{
										echo'<input type="checkbox" class="custom-control-input" name="bud_c" value="0" id="custom-switch-2" checked>';
									}  
								 ?>
								  ...
								  <input class="form-control" type="text" name="budget" autocomplete="off" value="<?php echo $row["Budget"]; ?>"/>
							  </div>
						  </div>
					  </div>
					  <div class="bio">
						  <div class="col-md-5">
							  ...
							  <?php
									if($row['bio_check'] == 0){
										echo'<input type="checkbox" name="bio_c" value="1" class="custom-control-input" id="custom-switch-3">';	
									}else{
										echo'<input type="checkbox" name="bio_c" value="0" class="custom-control-input" id="custom-switch-3" checked>';
									}  
								 ?>
							  ...
							  <textarea name="bio" class="form-control"><?php echo $row["Bio"]; ?></textarea>
						  </div>
					  </div>
	   ...
	   <?php  }elseif($do == "Update"){
		...
		if($_SERVER['REQUEST_METHOD'] =='POST'){
			...
			if(isset($_POST['bio_c'])){
				$bio_c = 1;
			}else{
				$bio_c = 0;
			}

			if(isset($_POST['bud_c'])){
				$bud_c = 1;
			}else{
				$bud_c = 0;
			}
		   ...
		   //$pass = empty($_POST['new-password']) ? $_POST['old-password'] : sha1($_POST['new-password']);
			...
			foreach($formErrors as $error){
				...
				echo '<div class="inner-block" style="margin-top:0;padding-top:30px">
    <div class="inbox">
		  <i class="fa fa-user fa-2x" style="color:#B75E21;margin-right:30px"></i>
    	  <div class="info" style="display:inline">
			  <h2 style="display:inline;margin-bottom:0;color:#515A5A;font-family:Athelas">Account Information</h2>
		  ...
		  <div class="information" style="margin-top:30px">
			  <div class="row">
				  <form class="form" action="?do=Update" method="post">
					  <input class="form-control" type="hidden" name="investorid" autocomplete="off" value="' . $id . '"/>
					  <div class="details">
						  <div class="col-md-7">
							  <div class="in">
								  <label>First Name</label>
								  <input class="form-control" type="text" name="first" autocomplete="off" value="' . $row["Fname"] . '"/>
							  </div>
							  <div class="in">
								  <label>Last Name</label>
								  <input class="form-control" type="text" name="last" autocomplete="off" value="' . $row["Lname"] . '"/>
							  </div>
							  <div class="in">
								  <label>ID</label>
								  <!-- Switch -->
								  ...
								  <input class="form-control" type="text" name="id" autocomplete="off" value="' . $row["nationalid"] . '"/>
							  </div>
							  <div class="in">
								  <label>Age</label>
							  ...
							  <div class="in">
								  <label>Email</label>
								  <input class="form-control" type="email" name="email" autocomplete="off" value="' . $row["Email"] . '"/>
							  </div>
							  <div class="in">
								  <label>Gender</label>
							  ...
							  <div class="in">
								  <label>City</label>
								  <input class="form-control" type="text" name="city" autocomplete="off" value="'  . $row["City"] . '"/>
							  </div>
							  <div class="in">
								  <label>Phone Number</label>
								  <input class="form-control" type="tel" name="phone" autocomplete="off" value="' .  "0" . $row["PhoneNum"] . '"/>
							  </div>
							  <div class="in">
								  <label>Password</label>
								  <input class="form-control" type="hidden" name="old-password" autocomplete="off" value="' . $row["Password"] . '" required/>
								  <input class="form-control" type="password" name="password" autocomplete="off"/>
							  </div>
							  <div class="in">
								  <label>Budget Amount</label>
								  <!-- Switch -->
								  <div class="custom-control custom-switch">
								  <input type="checkbox" class="custom-control-input" name="bud_c" value="1" id="custom-switch-2" >
										<label class="custom-control-label" for="custom-switch-2"></label>
								  </div>
								  <input class="form-control" type="text" name="budget" autocomplete="off" value="' . $row["Budget"] . '"/>
							  </div>
						  </div>
					  </div>
					  <div class="bio">
						  <div class="col-md-5">
							  <label>Bio</label>
							   <!-- Switch -->
							  <div class="custom-control custom-switch">
							  <input type="checkbox" name="bio_c" value="1" class="custom-control-input" id="custom-switch-3">
									<label class="custom-control-label" for="custom-switch-3"></label>
							  </div>
							  <textarea name="bio" class="form-control">' . $row["Bio"] . '</textarea>
						  </div>
					  </div>
					  <div class="buttons pull-right">
						  <button style="border:1px solid #D68910;color:#D68910" type="submit" name="edit" class="btn btn-primary edit">Edit</button>
          ...
          <div class="clearfix"> </div>     
			...
			if(empty($formErrors)){
				...
				$stmt2 = $con->prepare("SELECT * FROM investor WHERE Email = ? AND nationalid != ?");
    ...
    <div class="inbox">
          ...
          <div class="clearfix"> </div>     
						...
						$stmt = $con->prepare("UPDATE investor SET Fname = ?, Lname = ? , Email = ? , Age = ?, PhoneNum = ?, Password = ? , Bio = ? , Gender = ? , Budget = ? , City = ? , bio_check=? , budget_check=?,id_check=? WHERE nationalid = ?");
					$stmt->execute(array($first , $last , $email , $age , $phone , $password , $bio , $gender , $budget, $city ,$bio_c, $bud_c,$id_c,  $id));
