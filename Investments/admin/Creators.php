...
<div class="inner-block">
  ...
  <div class="inner-block" style="margin-top:0;padding-top:0">
    <div class="inbox">
    	  ...
    	  <h2 style="display:inline;margin-left:20px;color:#515A5A;font-family:Athelas">Creators</h2>
                              ...
                              <tbody>
							   ...
							   ?> 
                                <tr>
								  ...
								  <td>
									  <a title="Delete" href="Creators.php?do=Delete&creatorid=<?php echo $pat['nationalid']; ?>" class="confirm icons"><i class="fa fa-trash"></i></a>
									  <?php if($pat['state'] == "0"){ ?>
									  
									  
									  <a title="UnBanned" href="Creators.php?do=UnBanned&creatorid=<?php echo $pat['nationalid']; ?>" class="icons"><i class="fa fa-close"></i></a>
									  
									  
									  <?php }elseif($pat['state'] == "1"){ ?>
									  
									  <a title="Banned" href="Creators.php?do=Banned&creatorid=<?php echo $pat['nationalid']; ?>" class="icons"><i class="fa fa-check"></i></a>
...
<?php }elseif($do == "Banned"){
	 ...
	 //echo "<div class='container'>";
		 ...
		 include('../connect.php');  						  
		 $stmt = $con->prepare("SELECT * FROM creator WHERE nationalid= ?");
		 ...
		 $count = $stmt->rowCount();
			...
			if($count > 0){
				...
				$stmt = $con->prepare("UPDATE creator SET state = 0 WHERE nationalid = ?");
				...
				<div class="inner-block" style="margin-top:0;padding-top:0">
				<div class="alert alert-success">Creator Has Banned Successfully
                              ...
                              <tbody>';
								...
								foreach($rows as $pat)
								{
                                 ...
                                 <td>' . $pat['nationalid'] . '</td>
								  ...
								  <td>' . $pat['Bio'] . '</td>	
								  <td>
									  <a title="Delete" href="Creators.php?do=Delete&creatorid=' .  $pat['nationalid'] . '" class="confirm icons"><i class="fa fa-trash"></i></a>';
								if($pat['state'] == "0"){
									  
									  
									  echo '<a title="UnBanned" href="Creators.php?do=UnBanned&creatorid=' . $pat['nationalid'] . '" class="icons"><i class="fa fa-close"></i></a>';
									  
									  
								 }elseif($pat['state'] == "1"){
									  
									  echo '<a title="Banned" href="Creators.php?do=Banned&creatorid=' . $pat['nationalid'] . '" class="icons"><i class="fa fa-check"></i></a>';
	...
	$creatorid = isset($_GET['creatorid']) && is_numeric($_GET['creatorid']) ? intval($_GET['creatorid']) : 0;
		 ...
		 $count = $stmt->rowCount();
			...
			if($count > 0){
				...
				$stmt = $con->prepare("UPDATE creator SET state = 1 WHERE nationalid = ?");
				...
				<div class="inner-block" style="margin-top:0;padding-top:0">
				<div class="alert alert-success">Creator Has UnBanned Successfully
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						</button></div>
    <div class="inbox">
		 ...
		 $id = isset($_GET['creatorid']) && is_numeric($_GET['creatorid']) ? intval($_GET['creatorid']) : 0;
		 ...
		 $count = $stmt->rowCount();
			...
			if($count > 0){
				...
				$stmt = $con->prepare("DELETE FROM creator WHERE nationalid = :nationalid");
				...
				<div class="inner-block" style="margin-top:0;padding-top:0">
				<div class="alert alert-success">Creator Deleted Successfully
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						</button></div>
    <div class="inbox">
                            ...
                            <div class="table-responsive" style="margin-top:60px">
                              ...
                              <tbody>';
								...
								if($pat['state'] == "0"){
									  ...
									  echo '<a title="Banned" href="Creators.php?do=Banned&creatorid=' . $pat['nationalid'] . '" class="icons"><i class="fa fa-close"></i></a>';
									  
									  
								 }elseif($pat['state'] == "1"){
									  
									  echo '<a title="Un Banned" href="Creators.php?do=UnBanned&creatorid=' . $pat['nationalid'] . '" class="icons"><i class="fa fa-check"></i></a>';
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li class="activ"><a href="creators.php"><i class="fa fa-user"></i><span>Creators</span></a></li>
