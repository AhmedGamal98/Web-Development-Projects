...
<div class="container" style="margin-bottom:50px;height:450px">
      <div class="card card-login mx-auto mt-5">
        <div style="background-color:#F3BD00;color:#FFF" class="card-header">Reset Password</div>
        <div class="card-body">
          ...
          <form>
            ...
            <input style="background-color:#F3BD00;border:none" type="submit" class="btn btn-primary btn-block" value="Reset Password"/>
          </form>
          <div class="text-center">
            <a style="color:#F3BD00" class="d-block small" href="signin.php">Login Page</a>
          </div>
        </div>
      </div>
    </div>
