                ...
                <table class="table" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
						<a  onclick="return confirm('Are You Sure?');" style="background: #FFF; color:#333" href="users.php?do=Delete&userid=<?php echo $pat["traineeID"]; ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
					  </td>
                    </tr>
                    <?php } ?>
                  </tbody>
     ...
     <?php
		 ...
		 $count = $stmt->rowCount();
			...
			if($count > 0){
				...
				$stmt = $con->prepare("DELETE FROM trainee WHERE traineeID = :userid");
				...
				echo '
				<div class="alert alert-success">User Deleted Successfully
                ...
                <table class="table" width="100%">
                  ...
                  <tbody>';
                    ...
                    echo '<tr>
                      ...
                      <td>'  .$pat["type"] .  '</td>
                      <td>
						<a  onclick="return confirm(\'Are You Sure?\');" style="background: #FFF; color:#333" href="users.php?do=Delete&userid=' . $pat["traineeID"] . '" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
					  </td>
                    </tr>';
                     } 
                  echo '</tbody>
