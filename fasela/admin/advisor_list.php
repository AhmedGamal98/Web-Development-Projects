...
<body>
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" padding-top="20px">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">
              ...
              <a href="#"><button class="btn btn-outline-primary " style="width:190px;" id="s_btn" type="button" style="margin-left: 30px;">عرض قائمة الاستشاريين</button></a>
      ...
      <header>
        ...
        <div class="content">
            <div class="container">
              <h1 style="text-align: center; color:#fff; font-size:60px;">قائمة الاستشاريين</h1><br>
              <table class="table">
                <thead style="background-color: rgba(31, 134, 59, .7); color:#fff;">
                  <tr>
                    <th scope="col">كود الاستشاري</th>
                ...
                <tbody style="background-color: #fff;">
	                ...
	                //$user = "advisor";
					include('connection.php');  
					$sql = $con->prepare("SELECT * FROM users WHERE type='advisor'");
					$sql->execute();
					$rows = $sql->fetchAll();
                  ...
                  <tr>
                    ...
                    <td><a href="advisor_profile.php?userid=<?php echo $pat["user_id"]; ?>"><button class="btn btn-outline-primary active" id="s1_btn" type="button">عرض الصفحة الشخصية</button></a> </td>
