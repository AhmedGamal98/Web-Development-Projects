        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex">
              ...
              <a href="advisor_list.php"><button class="btn btn-outline-primary " style="width:190px;" id="s_btn" type="button" style="margin-left: 30px;">عرض قائمة الاستشاريين</button></a>
            ...
            <div class="container"><br>
                <div class="row" style="margin-right: 180px;">
                    <div class="col-12">
						...
						<img class="user_profile" src="data:image;base64,<?php echo $pat["image"]; ?>" alt="...">	
                    </div>
