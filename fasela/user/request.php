    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light" style="padding-top: 20px;">
      ...
      <header>
        ...
        <div class="content">
            ...
            <h1>طلب استشارة</h1><br>
            <form action="?do=Insert" method="post">
              <div class="row mb-3">
                <div class="col-sm-10">
                    <input class="form-control form-control-lg" name="name" type="text" placeholder="اسم الطلب" aria-label=".form-control-lg example" required>
                </div>
              </div>
              <div class="row mb-3">
                <div class="col-sm-10">
                    <textarea name="desc" id="" cols="83" rows="3" placeholder="وصف الطلب" required></textarea>
                </div>
              </div>
              
              <button type="submit" style="float: left;" class="btn btn-primary">إرسال الطلب</button>
		  ...
		  <?php }elseif($do == "Insert"){ 
			...
			//$city1    = $_POST["city1"]; 
						...
						$stmt = $con->prepare("INSERT INTO requests(title , description , date , user_id) VALUES(:title, :desc , :date , :user_id)");
					...
					<div class="container" style="margin-top:30px;margin-bottom:70px"><div dir="rtl" class="alert alert-info">تم ارسال طلب الاستشاره بنجاح
					
					</div></div>
          <div class="content">
          
            <h1>طلب استشارة</h1><br>
            <form action="?do=Insert">
              <div class="row mb-3">
                <div class="col-sm-10">
                    <input class="form-control form-control-lg" name="name" type="text" placeholder="اسم الطلب" aria-label=".form-control-lg example" required>
                </div>
