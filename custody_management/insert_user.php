...
<html lang="en">
    ...
    <head>
        ...
        <title>Custody Management - Insert Users</title>
                    ...
                    <div class="row mt-5">
                        ...
                        <?php if($do == "Manage"){ ?>
                            ...
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                ...
                                Full Name or Username or Email is already used. Please try again.
                            ...
                            <?php } ?>
                            <form action="include/insert_new_user.php" method="post" role="form" class=" php-email-form">

                                <br>
                                <div class="row">
                                    <div class="col-md-3 form-group mt-3 mt-md-0">
                                        <label style="margin-top: 4px;font-size: 21px;">Full Name</label>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group mt-3 mt-md-0">
                                        <label style="margin-top: 4px;font-size: 21px;">UserName</label>
                                    </div>
                                    <div class="col-md-9 form-group mt-3 mt-md-0">
                                ...
                                <div class="row">
                                    <div class="col-md-3 form-group mt-3 mt-md-0">
                                        <label style="margin-top: 4px;font-size: 21px;">Phone</label>
                                    </div>
                                    <div class="col-md-9 form-group mt-3 mt-md-0">
