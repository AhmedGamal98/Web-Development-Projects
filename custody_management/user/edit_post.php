<?php
  ...
  $id = $_GET['id'];
  $sql11 =$con->prepare("SELECT * FROM posts where post_id = ?");
...
<html lang="en">
    ...
    <head>
        ...
        <title>Custody Management - Edit Post</title>
            ...
            <section class="section">
                ...
                <div class="row container m-5">
                    ...
                    <?php }elseif($do == "less"){ ?>
                        ...
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <i class="bi bi-exclamation-octagon me-1"></i>
                            Quantity Should be more than your stock.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    <?php } ?>
                        <!-- Default Card -->
                        <form action="../include/edit_post.php" method="post">
                                    ...
                                    <div class="row container">
                                        ...
                                        <div class="col-lg-10">
                                            <?php
                                                ...
                                                $sql12 =$con->prepare("SELECT * FROM items where item_id = ?");
                                                $sql12->execute(array($row11['item_id']));
                                                $row12 =$sql12->fetch();
                                            ?>
                                            <select class="form-select"  aria-label="Default select example" required disabled>

                                                <option selected   value="<?php echo $row12['item_id'];?>"><?php echo $row12['item_id'];?> - <?php echo $row12['item_name'];?></option>
                                                
                                            </select>
                                            <input name="post_id" value="<?php echo $row11['post_id'];?>" hidden></input>
                                            <input name="item_id" value="<?php echo $row12['item_id'];?>" hidden></input>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row container">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="number" value="<?php echo $row11['quantity'];?>" name="quantity" class="form-control" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row container">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="info"
                                                style="height: 100px"><?php echo $row11['info'];?></textarea>
                                        </div>
                                    </div>
                                    <br><br>
                                        ...
                                        <div class="col-lg-12">
                                            <button style="margin-left: 60px;" type="submit"
                                                class="btn btn-outline-primary"><i
                                                    ...
                                                    class=" ri-ball-pen-line "></i> Edit</button>
                                        </div>
