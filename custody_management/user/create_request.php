...
<html lang="en">
    ...
    <head>
        ...
        <title>Custody Management - Create Post</title>
                                    ...
                                    <a href="mailto:'.$row3['email'].'"> <i style="font-size: 29px;"
                                      ...
                                      <div class="row g-0">
                                          ...
                                          <div class="col-sm-5">
                                              ...
                                              <input hidden  name="item_id" value="'.$row1['item_id'].'">
                                              <input hidden  name="from_id" value="'.$_SESSION['id'].'">
                                              <input hidden  name="to_id" value="'.$row['user_id'].'">
                                              <small>Note: number should be =< quantity</small>
                                          </div>
                                          ...
                                          <div class="col-sm-3">
                                                  ...
                                                  <button type="submit" class="btn btn-outline-primary"><i
                                                          style="font-size:17px;margin-top:0px;margin-right:5px;"
                                                          class=" ri-ball-pen-line "></i> Request</button>
