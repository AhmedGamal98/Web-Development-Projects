...
<html lang="en">
    ...
    <head>
        ...
        <title>Custody Management - My Posts</title>
    ...
    <body>
        ...
        <main id="main" class="main">
            ...
            <section class="section">
                ...
                <?php
                      $sql =$con->prepare("SELECT * FROM posts where user_id = ?AND quantity > 0");
                      $sql->execute(array($_SESSION['id']));
                     
                      
                      $rows =$sql->fetchAll($con::FETCH_ASSOC);
                        foreach ($rows as $row){
                          $sql1 =$con->prepare("SELECT * FROM items where item_id = ?AND quantity > 0");
