                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                ...
                                <div class="alert alert-info alert-dismissible" role="alert">
                                    ...
                                    Announcement has been edited successfully.
                                </div>
                                ...
                                <div class="card mb-4">
                                    <div
                                        ...
                                        <div class="col-9 ">
                                            <h6 class="m-0 font-weight-bold " style="color: #456b41">Announcements</h6>
                                        </div>
                                        <div class="col-3 ">
                                            <a href="add_ann.php"><button style="margin-top: 15px;" type="button"
                                                    class="btn btn-outline-primary mb-1">Add New
                                    ...
                                    <div class="table-responsive p-3">
                                        <table class="table align-items-center table-flush table-hover"
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql =$con->prepare("SELECT * FROM announcment");
                                                    $sql->execute();
                                                    ...
                                                    $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                                        foreach ($rows as $row){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>'.$row['admin_id'].'</td>
                                                                <td>'.$row['ann_title'].'</td>
                                                                <td>'.$row['ann_message'].'</td>
                                                                <td> <a href="edit_ann.php?id='.$row['ann_id'].'"><button type="button"
                                                                class="btn btn-outline-info mb-1">Edit</button></a>
                                                        <a href="../include/del_ann.php?id='.$row['ann_id'].'"
                                                            onclick="return confirm(\'Are you sure you want to delete this announcement?\');"><button
                                                                type="button"
                                                                class="btn btn-outline-danger mb-1">Delete</button></a>
                                                    </td>
                                                    </tr>
                                                            ';
                                                        }
