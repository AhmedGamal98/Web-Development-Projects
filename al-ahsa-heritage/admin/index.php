                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Farmers Accounts</li>
                            </ol>
                        </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card mb-4">
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold " style="color: #456b41">Farmers Accounts</h6>
                                    </div>
                                        ...
                                        <table class="table align-items-center table-flush table-hover"
                                          ...
                                          $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                            foreach ($rows as $row){
                                              ...
                                              '<tr>
                                              <td>'.$row['farmer_id'].'</td>
                                              <td><img src="data:image/jpeg;base64,'.base64_encode($row['img']).'" width="30%" alt=""></td>
                                              <td>'.$row['fname'].'</td>
                                              <td>'.$row['lname'].'</td>
                                              <td>'.$row['phone'].'</td>
                                              ...
                                              <td><span class="badge badge-warning">Pending</span></td>
                                                    <td> <a href="../include/accept_farmer.php?id='.$row['farmer_id'].'" 
                                                            onclick="return confirm(\'Are you sure you want to accept this user?\');"><button
                                                                type="button"
                                                                class="btn btn-outline-success mb-1">Accept</button></a>
                                                        <a href="../include/reject_farmer.php?id='.$row['farmer_id'].'" 
                                                            onclick="return confirm(\'Are you sure you want to reject this user?\');"><button
                                                                type="button"
                                            ...
                                            echo 
                                                ...
                                                '<tr>
                                                <td>'.$row['farmer_id'].'</td>
                                                <td><img src="data:image/jpeg;base64,'.base64_encode($row['img']).'" width="20%" alt=""></td>
                                                <td>'.$row['fname'].'</td>
                                                <td>'.$row['lname'].'</td>
                                                <td>'.$row['phone'].'</td>
                                                <td>'.$row['street_name'].'</td>
