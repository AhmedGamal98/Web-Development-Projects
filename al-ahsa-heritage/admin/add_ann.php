                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card mb-4">
                                    <div
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Add New Announcement</h6>
                                    </div>
                                    <div class="card-body">
                                        <form action="../include/add_announcment.php?id=<?php echo $_SESSION['id'];?>" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="title" id="exampleInputTitle1"
                                                    aria-describedby="" placeholder="Enter Title" required>

                                            </div>
                                            <div class="form-group">
                                                <label for="exampleFormControlTextarea1">Announcement Message</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1"
                                                    placeholder="Enter Announcement Message" name="message" rows="4"
                                                    required></textarea>
                                            </div>
