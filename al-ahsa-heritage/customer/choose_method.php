                            ...
                            <div class="col-lg-12">
                                <div class=" mb-4">
                                    <div class="  py-3 d-flex flex-row align-items-center justify-content-between">
                                        <div class="col-10 ">
                                            <h6 class="m-0 font-weight-bold " style="color: #456b41">Payment Methods
                                            </h6>
                                        </div>
                                        <div class="col-2 ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h5 class="card-title">Choose Payment Method</h5><br>
                                                    <div class="row">

                                                        <div class="col-lg-2">
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <a href="../include/clear_cart_receiving.php"><button
                                                                    style="margin-top: 15px; width: 250px;"
                                                                    type="button"
                                                                    class="btn btn-outline-primary mb-1">Payment When
                                                                    Receiving</button></a>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <a href="checkout.php"><button
                                                                    style="margin-top: 15px; width: 250px;"
                                                                    type="button"
                                                                    class="btn btn-outline-primary mb-1">Online
                                                                    Payment</button></a>
                                                        </div>
                                                        <div class="col-lg-2"></div>
                                                    </div>
