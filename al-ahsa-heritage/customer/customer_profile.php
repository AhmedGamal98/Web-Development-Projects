                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item active" href="customer_profile.php">
                    ...
                    <div class="container-fluid" id="container-wrapper">
                        ...
                        <div class="row">
                            ...
                            <?php if($do == "Manage"){ ?>
                                ...
                                <?php }elseif($do == "customer_edit"){ ?>
                                <div class="alert alert-info alert-dismissible" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                    Customer profile has been edited successfully.
                                </div>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="../include/update_customer_profile.php" method="post">
                                            <div class="form-group">
                                                <label for="exampleInputName1">ID</label>
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    aria-describedby="" name="customer_id" placeholder="ID" value="<?php echo $_SESSION['id']?>" required
                                                    disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName2"
                                                    aria-describedby="" name="lname" placeholder="Enter Last Name" value="<?php echo $_SESSION['lname']?>"
                                                    required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control" id="exampleInputEmail1"
                                                    aria-describedby="" name="email" placeholder="Enter Email" value="<?php echo $_SESSION['email']?>"
                                                    required disabled>
