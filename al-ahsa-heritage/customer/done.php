                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="cart.php">My Cart (Product List)</a></li>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <i class="fa-solid fa-circle-check"
                                            style="color: green; margin-left:43%;font-size:100px;"></i> <br> <br>
                                        <p
                                            style="margin: auto 0; margin-bottom: 50px; font-size: 23px; font-weight: bold; text-align: center;">
                                            Done, your purchasing request has been sent successfully</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3"></div>
