                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Visits List</li>
                            </ol>
                        </div>
                        <?php if($do == "Manage"){ ?>
                            ...
                            <div class="col-lg-12">
                                <div class="card mb-4">
                                    <div
                                        ...
                                        <div class="col-10 ">
                                            <h6 class="m-0 font-weight-bold " style="color: #456b41">Visits List</h6>
                                        </div>
                                        <div class="col-2 ">
                                            <!--<a href="add_visit.php"><button style="margin-top: 15px;" type="button"
                                                    class="btn btn-outline-primary mb-1">Add New Visit</button></a>-->
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="table-responsive p-3">
                                        <table class="table align-items-center table-flush table-hover"
                                            ...
                                            <tbody>
                                            <?php
                                                    $sql =$con->prepare("SELECT * FROM reservation where customer_id=?");
                                                    $sql->execute(array($_SESSION['id']));
