                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="table-responsive p-3">
                                        <table class="table align-items-center table-flush table-hover"
                                            ...
                                            <tbody>
                                            <?php
                                                    $sql =$con->prepare("SELECT * FROM bills where farmer_id=?");
                                                    ...
                                                    $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                                        foreach ($rows as $row){
                                                            ...
                                                            if($row['status'] == 1){
                                                                ...
                                                                <td>
                                                                    <form action="../include/change_bill_status.php?id='.$row['bill_id'].'" method="post">
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                            ...
                                                                            <div class="col-6">
                                                                                <button disabled
                                                                                    onclick="return confirm(\'Are you sure you want to change this product status\');"
                                                                                    type="submit"
                                                                                    class="btn btn-outline-info mb-1">Edit</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </td>
