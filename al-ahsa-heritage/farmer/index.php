                            ...
                            <?php if($do == "Manage"){ ?>
                                ...
                                <div class="card mb-4">
                                    <div
                                        ...
                                        <div class="col-10 ">
                                            <h6 class="m-0 font-weight-bold " style="color: #456b41">Products List</h6>
                                        </div>
                                        <div class="col-2 ">
                                            <a href="add_product.php"><button style="margin-top: 15px;" type="button"
                                                    class="btn btn-outline-primary mb-1">Add New Product</button></a>
                                        </div>
                                    </div>
                                    <br>
                                                        ...
                                                        foreach ($rows as $row){
                                                            echo'
                                                                <tr>
                                                                  ...
                                                                  <td><img src="data:image/jpg;charset=utf8;base64,'.base64_encode($row['img']).'" width="30%" alt=""></td>
                                                                  <td>'.$row['product_name'].'</td>
                                                                  <td>'.$row['price'].'</td>
                                                                  <td>'.$row['quantity'].'</td>
                                                                  <td>'.$row['description'].'</td>

                                                                  <td> <a href="edit_product.php?id='.$row['product_id'].'"><button type="button"
                                                                              class="btn btn-outline-info mb-1">Edit</button></a></td>
                                                              </tr>
                                                            ';
                                                        }
