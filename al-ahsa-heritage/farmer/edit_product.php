                ...
                <div id="content">
                    ...
                    <div class="container-fluid" id="container-wrapper">
                        ...
                        <div class="row">
                            ...
                            <?php
                                        $id = $_GET['id'];
                                        $sql =$con->prepare("SELECT * FROM product where product_id=?");
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="../include/edit_p.php?id=<?php echo $row['product_id'];?>"
                                            enctype="multipart/form-data" method="post">
                                            <div class="form-group">
                                                <label for="exampleInputName1">Product Name</label>
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    aria-describedby="" placeholder="Enter Title" name="p_name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputPrice1"
                                                    aria-describedby="" placeholder="Enter Price" name="p_price"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputQunatity1"
                                                    aria-describedby="" placeholder="Enter Qunatity" name="p_quantity"
                                                    value="<?php echo $row['quantity'];?>" required>
                                                    <input type="number"  name="farmer_id"
                                                    value="<?php echo $row['farmer_id'];?>" required hidden>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1"
                                                    placeholder="Enter Description" rows="4" name="p_desc"
