                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <?php } ?>
                            <form action="include/signup_farmer.php" method="post" role="form" class="php-email-form"
                                ...
                                <div class="row">
                                    <div class=" col-3 form-group mt-3 mt-md-0">
                                        <label for="Street Name" style="margin-top: 9%;">Street Name</label>
                                    </div>
                                    <div class="col-9 form-group mt-3 mt-md-0">
                                ...
                                <div class="row">
                                    <div class=" col-3 form-group mt-3 mt-md-0">
                                        <label for="image" style="margin-top: 9%;">Profile Image</label>
                                    </div>
                                    <div class="col-9 form-group mt-3 mt-md-0">
                                ...
                                <div class="text-center"><a style="color: rgb(0, 0, 190); text-decoration: underline;"
                                        href="sign_up_customer.php">Sign Up As Customer</a></div><br>
                                <div class="text-center"><a style="color: rgb(0, 0, 190); text-decoration: underline;"
