...
<html lang="en">
    ...
    <head>
        ...
        <title>Al-Ahsa Heritage - Sign In</title>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <?php }elseif($do == "pending"){ ?>
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                <i class="bi bi-exclamation-octagon me-1"></i>
                                This user still in pendding stage.
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                            ...
                            <?php }elseif($do == "farmer-s"){ ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <i class="bi bi-exclamation-octagon me-1"></i>
                                This page can be reached only by farmer. Please try again.
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                            <?php }elseif($do == "customer-s"){ ?>
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <i class="bi bi-exclamation-octagon me-1"></i>
                                This page can be reached only by customer. Please try again.
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                            <?php }elseif($do == "register-done"){ ?>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <i class="bi bi-check-circle me-1"></i>
                                Account has been registered successfully, you can log in now.
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                            ...
                            <?php } ?>
                            <br><br>
                            <form action="include/sign_in.php" method="post" role="form" class="php-email-form">
                                <h2 class="text-center">Sgin In</h2> <br><br>
                                <div class="row">
                                    <div class=" col-2 form-group mt-3 mt-md-0">
                                        <label for="email" style="margin-top: 9%;">Email</label>
                                    </div>
                                    <div class="col-10 form-group mt-3 mt-md-0">
                                ...
                                <br><br>
                                <div class="text-center"><button type="submit">Sign In</button></div><br>
                                <div class="text-center"><a style="color: rgb(0, 0, 190); text-decoration: underline;"
                                        href="sign_up_customer.php">Create new account</a></div><br>
                                <div class="text-center"><a style="color: rgb(0, 0, 190); text-decoration: underline;"
                                        href="forget.php">Forgot Password?</a></div>
                            </form>
                        </div>
                        <div class="col-lg-2 ">
