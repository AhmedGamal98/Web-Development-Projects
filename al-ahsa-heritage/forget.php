                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <?php } ?>
                            <form action="include/reset_pass.php" method="post" role="form" class="php-email-form">
                                ...
                                <div class="row">
                                    <div class=" col-2 form-group mt-3 mt-md-0">
                                        <label for="email" style="margin-top: 9%;">New Password</label>
                                    </div>
                                    <div class="col-10 form-group mt-3 mt-md-0">
                                ...
                                <br><br>
                                <div class="text-center"><button type="submit">Reset Password</button></div><br>
                                <div class="text-center"><a style="color: rgb(0, 0, 190); text-decoration: underline;"
                                        href="login.php">Sign In</a></div><br>
                                <div class="text-center"><a style="color: rgb(0, 0, 190); text-decoration: underline;"
                                        href="sign_up_customer.php">Create new account</a></div>
