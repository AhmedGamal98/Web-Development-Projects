		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
			<div class="main-page">
				...
				<div class="tables" style="margin-top:40px;height:800px">
					...
					<h3 style="display:inline;color: #FFF" class="title1">طلبات التحاليل</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4>ادارة طلبات التحاليل :</h4>
							...
							<tbody class="text-center">
							   ...
							   ?>
								<tr class="active">
									...
									<td><?php echo $pat["analysis"]; ?></td>
									<td>
										<a style="background: #FFF; color:#333" href="requests_lab.php?do=Add&checkid=<?php echo $pat["checkup_id"]; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> اضافة نتائج الفحوصات للسجل الطبي للمريض</a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
				...
				<div class="widget-shadow">
					<div class="login-body">
						<form action="?do=Insert" method="post">
							...
							<textarea name="analysis" class="form-control" style="height:250px;margin-bottom:20px;resize:none" placeholder="نتيجة التحليل"></textarea>
			...
			//Get Varaiables from Post Method
			    ...
			    $stmt = $con->prepare("UPDATE checkups SET analysis_result = '$analysis' , artist_id = $id  , state = 1 WHERE checkup_id = :checkid");
				...
				$stmt->execute();   
					...
					echo '<div style="margin-top:40px" dir="rtl" class="alert alert-info">تم اضافة نتيجة لهذه التحاليل بنجاح
