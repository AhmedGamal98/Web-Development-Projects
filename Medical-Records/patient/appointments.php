		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
			<div class="main-page">
				...
				<div class="tables" style="margin-top:40px;height:600px">
					...
					<h3 style="display:inline;color: #FFF" class="title1">مواعيدك</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						...
						<table class="table" dir="rtl">
							...
							<tbody class="text-center">
								...
								include('../connect.php');  
								$sql = $con->prepare("SELECT * FROM appointments WHERE national=$national");
								$sql->execute();
								$rows = $sql->fetchAll();
							   ...
							   ?>
								<tr class="active">
									<th scope="row"><?php echo $pat["appointment_id"]; ?></th>
									<!--<td>علي</td>-->
