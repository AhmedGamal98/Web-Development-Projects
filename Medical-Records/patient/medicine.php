		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
			<div class="main-page">
				...
				<div class="tables" style="margin-top:40px;height:600px">
					...
					<h3 style="display:inline;color: #FFF" class="title1">الوصفات الطبية</h3>
							...
							<tbody class="text-center">
							   ...
							   ?>
								<tr class="active">
									...
									<td>
										<a style="background: #FFF; color:#333;font-family:Almarai" href="medicine.php?do=Result&medicineid=<?php echo $pat["medicine_id"]; ?>" class="btn btn-danger"><i class="fa fa-medkit"></i> الوصفة الطبية </a>
									</td>
								</tr>
								<?php } ?>
							</tbody>
				...
				<a style="display:inline;background: #FFF; color:#333;margin-left:4px;font-family:Almarai;width:100px;margin-top:30px" href="medicine.php" class="btn btn-primary pull-left">رجوع</a>
		    <div class="clearfix"></div>			
			<div class="tables" style="margin-top:40px;height:700px">
					...
					<h3 style="display:inline;color: #FFF" class="title1">الوصفات الطبية</h3>
					<div class="bs-example widget-shadow" data-example-id="contextual-table"> 
						<h4 style="font-weight:bold;color: #3A5D70" class="text-center">الوصفات الطبية</h4>
						<hr>
