	...
	<div class="main-content">
		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
			<div class="main-page">
				...
				<!--<a style="display:inline;background: #FFF; color:#333;margin-left:4px;font-family:Almarai;width:100px;margin-top:30px" href="show.php" class="btn btn-primary pull-left">رجوع</a>-->
		        <div class="clearfix"></div>	
