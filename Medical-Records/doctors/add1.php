	...
	<div class="main-content">
		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
				...
				<div class="widget-shadow">
					<div class="login-body">
						<form action="?do=Insert" method="post">
							...
							<div class="col=md-12">
								<div class="col-md-2" style="margin-top:100px;font-size:50px"><i class="fa fa-medkit"></i></div>
								<div class="col-md-10">
									<textarea name="med" style="height:250px;resize:none;padding:5px" placeholder="اكتب الوصفة التي يحتاج اليها المريض" class="form-control" required></textarea>	
			...
			//Get Varaiables from Post Method
			    ...
			    $stmt = $con->prepare("UPDATE medicines SET medicine_name = '$med'  WHERE patient_id = :patientid");
				...
				$stmt->execute();   
					...
					echo '<div style="margin-top:40px" dir="rtl" class="alert alert-info">تم اضافة وصف دواء لهذا المريض بنجاح
				...
				<div class="widget-shadow">
					...
					echo '<div style="margin-top:40px" dir="rtl" class="alert alert-info">يوجد وصف دواء من قبل
					<button type="button" class="close pull-left" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						</button>
					</div>';
					echo '<a style="display:inline;background: #FFF; color:#333;margin-left:4px;font-family:Almarai;width:100px;margin-top:30px" href="medical-data.php?patientd=' . $patientd . '" class="btn btn-primary pull-left">رجوع</a>
		        <div class="clearfix"></div>	
				<div class="login-page" style="margin-top:140px;height:500px;width:90%">
				<div class="widget-shadow">
					<div class="login-body">
					...
					echo '<div style="margin-top:40px" dir="rtl" class="alert alert-info">يجب اضافة تشخيص للمريض أولا
					<button type="button" class="close pull-left" data-dismiss="alert" aria-label="Close">
						<span aria-hidden="true">&times;</span>
						</button>
					</div>';
					echo '<a style="display:inline;background: #FFF; color:#333;margin-left:4px;font-family:Almarai;width:100px;margin-top:30px" href="medical-data.php?patientd=' . $patientid . '" class="btn btn-primary pull-left">رجوع</a>
		        <div class="clearfix"></div>	
				<div class="login-page" style="margin-top:140px;height:500px;width:90%">
				<div class="widget-shadow">
					<div class="login-body">
