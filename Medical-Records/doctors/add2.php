	...
	<div class="main-content">
		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
				...
				<div class="widget-shadow">
					<div class="login-body">
						<form action="?do=Insert" method="post">
							...
							<div class="col=md-12">
								<div class="col-md-2" style="margin-top:100px;font-size:50px"><i class="fa fa-file-text-o"></i></div>
								<div class="col-md-10">
									<textarea name="tr" style="height:250px;resize:none;padding:5px" placeholder="اكتب التحاليل التي يحتاج اليها المريض" class="form-control" required></textarea>	
			...
			//Get Varaiables from Post Method
					...
					$stmt = $con->prepare("INSERT INTO  checkups(Type , analysis , patient_id , doctor_id) VALUES(:type , :analysis , :patient , :doctor)");
					...
					echo '<div style="margin-top:40px" dir="rtl" class="alert alert-info">تم طلب اجراء تحاليل  لهذا المريض بنجاح
