	...
	<div class="main-content">
		...
		<div id="page-wrapper" class="pull-left" style="background: url('layouts/images/doc.jpeg') no-repeat;background-size:cover">
				...
				<div class="widget-shadow">
					<div class="login-body">
						<form action="?do=Insert" method="post">
							...
							<div class="col=md-12">
								<div class="col-md-2" style="margin-top:100px;font-size:50px"><i class="fa fa-user"></i></div>
								<div class="col-md-10">
									<textarea name="st" style="height:250px;resize:none;padding:5px" placeholder="اكتب تشخيص المريض" class="form-control" required></textarea>	
			...
			//Get Varaiables from Post Method
					...
					$stmt = $con->prepare("INSERT INTO  medicines(diagnosis , patient_id , doctor_id) VALUES(:name , :patient , :doctor)");
					...
					echo '<div style="margin-top:40px" dir="rtl" class="alert alert-info">تم اضافة تشخيص لهذا المريض بنجاح
