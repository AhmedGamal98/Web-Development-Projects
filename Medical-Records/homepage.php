                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                       ...
                       <?php
                        ...
                        <li><a data-scroll href="#getintouch">تواصل معنا</a></li>
                        <li><a data-scroll href="#doctors">أطبائنا</a></li>
                        <li><a data-scroll href="#service">خدماتنا</a></li>
                        <li><a data-scroll href="#about">نبذة عنا</a></li>
            ...
            <div class="row">
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  <div class="appointment-form">
                     ...
                     <div class="form">
                        <form action="add.php" method="post" class="design login">
                           <fieldset>
							  <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="text" id="name" name="id" placeholder="رقم الهوية"  required/>
                                    </div>
                                 </div>
                              </div> 
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							  ...
							  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="date" id="name" name="date" placeholder="التاريخ"  required/>
                                    </div>
                                 </div>
                              </div> 
							  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 <div class="row">
                                    <div class="form-group">
                                       <input type="time" id="name" name="time" placeholder="الوقت"  required/>
                                    </div>
                                 </div>
                              </div>  
                              <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
