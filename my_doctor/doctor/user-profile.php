                    ...
                    <div class="card">
                        ...
                        <?php if($do == "Manage"){ ?>
                            ...
                            <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="../include/update_doc_profile.php" method="post" class="needs-validation">

                                    <div class="row mb-3">
                                        <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Doctor
                                            Name</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="name" type="text" class="form-control" id="fullName"
                                                value="<?php echo $_SESSION['doc_name'];?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="id" type="number" class="form-control" id="id"
                                                value="<?php echo $_SESSION['doctor_id'];?>" readonly required>
                                        </div>
                                    </div>

                                    <br>
                                    <?php
                                         $sql2 =$con->prepare("SELECT * FROM hospital where id=?");
                                         $sql2->execute([$_SESSION['hospital_id']]);
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="hospital" type="text" class="form-control" id="hospital"
                                                value="<?php echo $row2['name'];?>" readonly required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control" id="Email"
                                                value="<?php echo $_SESSION['doc_email'];?>" readonly>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="password" type="password" class="form-control"
                                                id="newPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters"  minlength="6">
