            ...
            <div class="row">
                ...
                <div class="section-title">
                    <div class="alert alert-success" role="alert">
                      Doctor has been enabled successfully
                    </div><br>
                                    ...
                                    <?php
                                            ...
                                            $rows =$sql->fetchAll($con::FETCH_ASSOC);
                                                ...
                                                echo 
                                                    ...
                                                    echo'
                                                    <td>Enabled</td>
                                                    <td><a href="../include/block_doc.php?id='.$row["id"].'"> <button type="button" class="btn btn-outline-danger"
                                                            onclick="confirm(\'Are you sure you want to block this doctor?\')">Block</button></a></td>
                                                    </tr>
                                                    ';
                                                    }elseif($row['status']==0){
                                                    echo"
                                                    <td>Blocked</td>
                                                    <td><a href='../include/enable_doc.php?id=".$row["id"]."'> <button type='button' class='btn btn-outline-success'
                                                            onclick='confirm(\"Are you sure you want to enable this doctor?\")'>Enable</button></a></td>
                                                    </tr>
                                                    ";
                                                    }
                                        }?>
