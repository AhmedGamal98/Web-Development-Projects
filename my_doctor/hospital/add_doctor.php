        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item ">
                ...
                <ul id="doctor-nav" class="nav-content collapsed" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="add_doctor.php" class="active">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="index.php">Doctors List</a></li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php if($do == "Manage"){ ?>
                                ...
                                <div class="section-title">
                                    <div class="alert alert-danger" role="alert">
                                        Email or doctor name or doctor ID already exist, try new one.
                                    </div><br>
                            ...
                            <form action="../include/add_doc.php" method="post" class="row g-3 needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="validationCustom01"
                                            placeholder="Enter Doctor Name" name="doc_name" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="age" class="form-control" id="validationCustom02"
                                            placeholder="Enter Doctor Age" pattern="/^-?\d+\.?\d*$/"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="id" class="form-control" id="validationCustom02"
                                            placeholder="Enter Doctor ID" minlength="10" pattern="/^-?\d+\.?\d*$/"
                                            onKeyPress="if(this.value.length==10) return false;" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                            Please enter ID & it should be 10 numbers.
                                        </div>
                                    </div>
                                </div>
                                <br><br><br>
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" name="phone" class="form-control" id="validationCustom02"
                                            placeholder="Enter Doctor Phone Number" minlength="10"
                                            pattern="/^-?\d+\.?\d*$/"
                                            onKeyPress="if(this.value.length==10) return false;" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        ...
                                        <div class="invalid-feedback">
                                            Please enter phone number & it should be 10 numbers.
                                        </div>
                                    </div>
                                </div>
                                <br><br><br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="invalid-feedback">
                                        Please enter doctor password & it Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters
                                        </div>
                                    </div>
                                </div>
                                <br><br><br>
