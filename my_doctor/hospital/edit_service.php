<?php
  ...
  $id= $_GET['id'];
  $sql =$con->prepare("SELECT * FROM service where id=?");
    $sql->execute([$id]);
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="../include/edit_serv.php?id=<?php echo $id;?>" method="post" class="row g-3 needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="validationCustom01"
                                            placeholder="Enter Service Name" name ="name" value="<?php echo $row['name'];?>" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="validationCustom02"
                                            placeholder="Enter Service Address" name="address" value="<?php echo $row['address'];?>" required>
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="number" class="form-control" name="price" id="validationCustom03"
